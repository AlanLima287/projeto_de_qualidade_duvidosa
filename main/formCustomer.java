...
public class formCustomer extends JDialog {
    ...
    public formCustomer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        reload();
    }
    ...
    private void initComponents() {
        ...
        list1 = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Customer>());
        jPanel1 = new JPanel();
        ...
        jTextField4= new JFormattedTextField(mask);
        try {
            mask = new MaskFormatter("(##) #####-####");
        } catch (Exception e) {}
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTable1, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.idCustomer}"), jTextField1, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTable1, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.phone}"), jTextField5, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jTextField6.setEditable(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTable1, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.birthDate}"), jTextField6, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void jButton6ActionPerformed(ActionEvent evt) {
        list1.add((Customer) new Customer());
    ...
    private void jButton9ActionPerformed(ActionEvent evt) {
        if (validateFields()) {
            ...
            Customer obj = list1.get(selectedLine);
            isEditing(false);
            dao.save(obj);
            reload();
        }
    ...
    private boolean validateFields() {
        ...
        if (jTextField4.getText().length() != 14) {
        ...
        if (!DefaultVerification.dateVerification(jTextField6.getText())) {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(formCustomer.class
                    .getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            formCustomer dialog = new formCustomer(new JFrame(), true);
